<x-template>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <p class="fs-4 animated slideInRight text-white">Welcome to
                                        <strong>ZD Suite</strong>
                                    </p>
                                    <h1 class="display-1 animated slideInRight mb-4 text-white">Unlock Your Business
                                        Growth</h1>
                                    <a class="btn btn-primary rounded-pill animated slideInRight py-3 px-4" href="">Explore
                                        More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <p class="fs-4 animated slideInLeft text-white">Welcome to <strong>ZD Suite</strong>
                                    </p>
                                    <h1 class="display-1 animated slideInLeft mb-5 text-white">Ready to Grow Your
                                        Business</h1>
                                    <a class="btn btn-primary rounded-pill animated slideInLeft py-3 px-4" href="">Explore
                                        More</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item h-100 border p-5">
            ...
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="h-100 d-flex align-items-center justify-content-center" style="min-height: 300px;">
                        <button class="btn-play" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/DWRcNpR6Kdc" data-bs-target="#videoModal" type="button">
                            <span></span>
                        </button>
                    </div>
                </div>
                <div class="col-lg-6 pt-lg-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="rounded-top mt-lg-5 bg-white p-5">
    ...
    <!-- Video Modal Start -->
    <div class="modal modal-video fade" id="videoModal" aria-labelledby="exampleModalLabel" aria-hidden="true" tabindex="-1">
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="ratio ratio-16x9">
                        <iframe class="embed-responsive-item" id="video" src="" allowfullscreen allowscriptaccess="always" allow="autoplay"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl pt-5">
        <div class="container">
            <div class="text-md-start pb-md-0 wow fadeInUp pb-5 text-center" data-wow-delay="0.1s" style="max-width: 500px;">
            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="project-item mb-5">
                    <div class="position-relative">
                        ...
                        <div class="project-overlay">
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" data-lightbox="project" href="img/project-1.jpg"><i class="fa fa-eye"></i></a>
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        ...
                        <div class="project-overlay">
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" data-lightbox="project" href="img/project-2.jpg"><i class="fa fa-eye"></i></a>
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="p-4">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        ...
                        <div class="project-overlay">
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" data-lightbox="project" href="img/project-3.jpg"><i class="fa fa-eye"></i></a>
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="p-4">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        ...
                        <div class="project-overlay">
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" data-lightbox="project" href="img/project-4.jpg"><i class="fa fa-eye"></i></a>
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="p-4">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item overflow-hidden rounded pb-4">
    ...
    <div class="container-xxl pt-5">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item p-lg-5 mb-5 rounded p-4">

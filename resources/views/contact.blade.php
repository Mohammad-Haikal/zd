<x-template>
    ...
    <div class="container-fluid page-header wow fadeIn mb-5 py-5" data-wow-delay="0.1s">
        <div class="container py-5 text-center">
            <h1 class="display-2 animated slideInDown mb-4 text-white">Contact Us</h1>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" id="message" style="height: 200px" placeholder="Leave a message here"></textarea>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex border-bottom mb-3 pb-3">
                        <div class="btn-square bg-primary rounded-circle flex-shrink-0">
                    ...
                    <div class="d-flex border-bottom-0 mb-3 pb-3">
                        <div class="btn-square bg-primary rounded-circle flex-shrink-0">
